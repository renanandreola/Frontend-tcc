...
export default (props) => {
  ...
  return (
    <>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mr-auto">
            <li className="nav-item">
              ...
              <button className="nav-link" onClick={GraphVisible}>
                Visão geral
              </button>
            </li>
            <li className="nav-item">
              {/* <a className="nav-link" href="">Dados financeiros</a> */}
              <button className="nav-link" onClick={FinanceVisible}>
                Dados financeiros
              </button>
            </li>
            <li className="nav-item">
              {/* <a className="nav-link" href="">Análise técnica</a> */}
              <button className="nav-link" onClick={TechVisible}>
                Análise técnica
              </button>
            </li>
            <li className="nav-item">
              {/* <a className="nav-link" href="">Sobre a empresa</a> */}
              <button className="nav-link" onClick={AboutVisible}>
                Sobre a empresa
              </button>
            </li>
            <li className="nav-item">
              <button className="nav-link" onClick={Calendar}>
                Calendário
              </button>
            </li>
            {haveToken && (
              <li className="nav-item" key="favoritar">
                <button className="nav-link" onClick={FavoriteTicker}>
                  <img
                    ...
                    src="https://cdn.icon-icons.com/icons2/1880/PNG/512/iconfinder-love-4341304_120541.png"
                  ></img>
                </button>
              </li>
            )}
      ...
      {financeVisible && <InfoTicker code={code} name={name}></InfoTicker>}

      {techVisible && (
        <StopwatchTicker code={code} name={name}></StopwatchTicker>
      )}

      {aboutVisible && <CompanyInfo code={code} name={name}></CompanyInfo>}
      {fullCalendar && <MyCalendar code={code} name={name}></MyCalendar>}
    </>
  );
};
